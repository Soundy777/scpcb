...
;--------------------------------------- Specialized Render World Function -------------------------------------------------------
...
Function CheckTriggers$()
	...
	Else
		For i = 0 To PlayerRoom\TriggerboxAmount-1
			...
			sx# = GetMeshScaleX(PlayerRoom\Triggerbox[i], 1)
			sy# = Max(GetMeshScaleY(PlayerRoom\Triggerbox[i], 1), 0.001)
			sz# = GetMeshScaleZ(PlayerRoom\Triggerbox[i], 1)
