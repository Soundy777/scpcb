...
;; ToDo:: better encapsulate these variables by provided accessors in their place
Global GameSaved% ; God knows what hellish extended usage this has
Global CanSave% = True	; This gets set based upon one of several events/npc states
