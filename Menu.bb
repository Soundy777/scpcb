		...
		Select MainMenuTab
			...
			Case 3,5,6,7 ;options
				...
				ElseIf MainMenuTab = 7 ;Advanced
					...
					ConsoleEnabled = DrawTick(x + 310 * MenuScale, y + MenuScale, ConsoleEnabled)
					If MouseOn(x+310*MenuScale,y+MenuScale,20*MenuScale,20*MenuScale) And OnSliderID=0
					...
					Config\Gameplay\UseNumericSeeds = DrawTick(x + 310 * MenuScale, y + MenuScale, Config\Gameplay\UseNumericSeeds)
					If MouseOn(x+310*MenuScale,y+MenuScale,20*MenuScale,20*MenuScale) And OnSliderID=0
					...
					If DrawTick(x + 310 * MenuScale, y, CurrFrameLimit > 0.0) Then
						...
						Color 255,255,0
						Text(x + 25 * MenuScale, y + 25 * MenuScale, Format(I_Loc\OptionName_FramelimitFps, Config\Graphics\Framelimit%))
