		...
		Select MainMenuTab
			...
			Case 3,5,6,7 ;options
				...
				ElseIf MainMenuTab = 7 ;Advanced
					;[Block]
					height = (325 + (CurrFrameLimit > 0.0) * 30) * Gfx\MenuScale
					DrawFrame(x, y, width, height)	
					...
					Color 255,255,255
					If DrawTick(x + 310 * Gfx\MenuScale, y, CurrFrameLimit > 0.0) Then
...
Function DrawLoading(percent%, shortloading=False)
	...
	Repeat 
		...
		Else
			...
			Color 0,0,0
			SetFont Font2
			Text(Config\Graphics\ScreenWidth / 2 + Max(1, Gfx\MenuScale), Config\Graphics\ScreenHeight / 2 + 80*Gfx\MenuScale+Max(1, Gfx\MenuScale), SelectedLoadingScreen\title, True, True)
			SetFont Font1
			RowText(SelectedLoadingScreen\txt[LoadingScreenText], Config\Graphics\ScreenWidth / 2-200*Gfx\MenuScale+Max(1, Gfx\MenuScale), Config\Graphics\ScreenHeight / 2 +120*Gfx\MenuScale+Max(1, Gfx\MenuScale),400*Gfx\MenuScale,300*Gfx\MenuScale,True)
			
			Color 255,255,255
			SetFont Font2
			Text(Config\Graphics\ScreenWidth / 2, Config\Graphics\ScreenHeight / 2 +80*Gfx\MenuScale, SelectedLoadingScreen\title, True, True)
			SetFont Font1
			RowText(SelectedLoadingScreen\txt[LoadingScreenText], Config\Graphics\ScreenWidth / 2-200*Gfx\MenuScale, Config\Graphics\ScreenHeight / 2 +120*Gfx\MenuScale,400*Gfx\MenuScale,300*Gfx\MenuScale,True)
